...
const Login = () => {
  return (
       ...
       <HelmetProvider>
        <Helmet><title>Trendhub | Login</title></Helmet>
        ...
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          <htmlForm className="space-y-6" action="#">
            ...
            <div className="flex items-start">
              ...
              <a
                href="#"
                className="ml-auto text-sm text-mainColor hover:underline"
              >
                Lost Password?
              </a>
            </div>
            <button
              type="submit"
              className="w-full text-white bg-mainColor hover:bg-mainColor focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center "
            >
